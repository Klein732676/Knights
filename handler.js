...
conn.sendMessage(m.chat, {text: `*⌬━─☯︎━𒊹︎︎︎━═𓆩🌑𓆪═━𒊹︎︎︎━☯︎─━⌬* 
*┊⇇نفذ منك الالماس*
*┊⇇استخدم امر❪.شراء❫ للمزيد*⌬━─☯︎━𒊹︎︎︎━═𓆩🌑𓆪═━𒊹︎︎︎━☯︎─━⌬*`, contextInfo: {externalAdReply : {mediaUrl: null, mediaType: 1, description: null, "title": wm, body: '', previewType: 0, "thumbnail": img.getRandom(), sourceUrl: [nna, md, yt, nn, tiktok].getRandom()}}}, { quoted: m })         
continue
}
...
*⌬━─☯︎━𒊹︎︎︎━═𓆩🌑𓆪═━𒊹︎︎︎━☯︎─━⌬*`, contextInfo: {externalAdReply : {mediaUrl: null, mediaType: 1, description: null, "title": wm, body: '', previewType: 0, "thumbnail": img.getRandom(), sourceUrl: [nna, md, yt, nn, tiktok].getRandom()}}}, { quoted: m })         
...
if (!m.fromMem && m.text.match(/(@972523048677|بوت|رين|تست|:v)/gi)) {
...
export async function callUpdate(callUpdate) {
    ...
    let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝐀𝐁𝐘𝐒𝐒_𝐁𝐎𝐓-𝙈𝘿 🌑;;;\nFN:𝐀𝐁𝐘𝐒𝐒_𝐁𝐎𝐓-𝙈𝘿\nORG:𝐀𝐁𝐘𝐒𝐒_𝐁𝐎𝐓-𝙈𝘿 🌑\nTITLE:\nitem1.TEL;waid=+201063808608\nitem1.X-ABLabel:Alakreb-𝙈𝘿 🌑\nX-WA-BIZ-DESCRIPTION:[❗] ᴇsᴄʀɪʙɪ sᴏʟᴏ ᴘᴏʀ ᴄᴏsᴀs ᴅᴇʟ ʙᴏᴛ.\nX-WA-BIZ-NAME:𝑹𝑰𝑵-𝑩𝑶𝑻 🌑\nEND:VCARD`
    await this.sendMessage(nk.from, { contacts: { displayName: '〘𝑹𝑰𝑵-𝑩𝑶𝑻〙', contacts: [{ vcard }] }}, {quoted: callmsg})
